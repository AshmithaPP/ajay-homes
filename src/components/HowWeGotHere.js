...
export default function HowWeGotHere() {
  ...
  return (
    <section
      ref={sectionRef}
      id="legacy"
      className={`relative w-full bg-white pt-6 pb-12 sm:pt-14 sm:pb-18 lg:py-20 2xl:py-24 text-slate-900 overflow-hidden transition-all duration-1000 ease-out ${
